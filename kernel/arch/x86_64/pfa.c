...
// it's lowk flipped, bc left shifting increases the actual bit were at, which is
// logically moving to the 'right' in the bit map
// 31, 30, ..., 3, 2, 1, 0 // first element of the bitmap looks like this
